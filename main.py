...
def basket_veri_hazirla(df):
    ...
    numeric = ["HomeScore","AwayScore","TotalLine","SpreadLine","HomeML","AwayML"]
...
def _spor_toto_milli_kupon_mu(spor_maclar):
    ...
    for m in spor_maclar:
        # _spor_toto_takim_benzerlik kendi normalizasyon/alias mantığını kullanır.
        # FIX19'daki var olmayan _spor_toto_takim_anahtar çağrıları kaldırıldı.
